    ...
    <div>
        ...
        <div className="offcanvas offcanvas-end" data-bs-scroll="true" tabIndex={-1} id="offcanvasCart" aria-labelledby="My Cart">
            ...
            <div className="order-md-last">
                    ...
                    {cart.length === 0 ? (
                        ...
                        <div className="row border border-secondary-100 mb-2">
                            ...
                            <div className="col-12 d-flex">
                                <button className="col-md-6 w-10 btn btn-primary btn-lg" type="button" onClick={() => removeFromCart(item.id, 1)} value={removeFromCart} > - </button>
                                <button className="col-md-6 w-10 btn btn-primary btn-lg" type="button" onClick={() => updateCartQuantity(item.id, 1)} > + </button>
                            </div>
                        </div>
                        ))
                ...
                <NavLink className="w-100 btn btn-primary btn-lg" to={"/checkout"} type="button" onClick={()=> Checkout()} >Continue to Checkout</NavLink>
                <button className="w-100 btn btn-primary btn-lg" type="submit" onClick={()=> clearCart()}>Clear Cart</button>
            </div>
            </div>
        </div>
            ...
            <div className="row justify-content-between align-items-center w-100">
                ...
                <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <ul className="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                        ...
                        <NavLink className="nav-link" to="/home" id="dropdownHome"aria-haspopup="true" aria-expanded="false">Home</NavLink>
                        
                        </li>
                        <li className="nav-item dropdown">
                        <NavLink className="nav-link " to="/shop" id="dropdownShop"  aria-haspopup="true" aria-expanded="false">Shop</NavLink>
                        <ul className="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                            
                        </ul>
                        </li>
                        <li className="nav-item dropdown">
                            <NavLink className="nav-link " to="/blog" id="dropdownBlog" aria-haspopup="true" aria-expanded="false">Blog</NavLink>
                    
                        </li>
                        <li className="nav-item dropdown">
                        <a className="nav-link dropdown-toggle" href="#" id="dropdownPages" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
                ...
                <ul className="list-unstyled d-flex m-0">
                    ...
                    <NavLink to="index.html"className="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">Cart <span >({cart.length})</span>
                    </NavLink>
                    </li>
